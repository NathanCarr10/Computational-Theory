...
My goal was to make the notebook easy to follow for someone who understands Python and basic cryptography but might not know the internal details of SHA-256. Each problem is explained step by step with code, comments, and tests so that the whole process is reproducible and understandable without me being present.
